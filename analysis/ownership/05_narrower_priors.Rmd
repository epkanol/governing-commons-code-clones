...
```
```{r}
figsave("05_red_jupiter_uranus.pdf", red_plot)
```
...
```
```{r}
figsave("05_blue_jupiter_uranus.pdf", blue_plot)
```
...
figsave("05_blue_red_complexity.pdf", complexity_plot)
```
...
```
```{r}
figsave("05_pop_level_betas.pdf", p)
```
...
```
```{r}
figsave("05_condeffect_added_vs_complex_green_jupiter.pdf", p)
```
```{r}
...
```
```{r}
figsave("05_condeffect_added_vs_complex_red_jupiter.pdf", p)
```
